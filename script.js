...
var spelerX = 1280/2; // x-positie van speler
var spelerY = 620; // y-positie van speler
...
var tekenSpeler = function(x, y) {
  ...
  ellipse(x, y, 75, 75);   
  fill("black");   
  var ogenUitElkaar = 14;   
  var ogenHoogte = 12;   
  var mondGrootte = 20;   
  ellipse(x + ogenUitElkaar, y - ogenHoogte, 10, 10);   
  ellipse(x - ogenUitElkaar, y - ogenHoogte, 10, 10);   
  ellipse(x, y + 12, mondGrootte, mondGrootte); 
};
